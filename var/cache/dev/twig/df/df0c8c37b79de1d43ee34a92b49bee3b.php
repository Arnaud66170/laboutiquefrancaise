...
class __TwigTemplate_d4be5e315f16f925f1bcfc20a3f95a12 extends Template
{
    private $source;
    private $macros = [];
...
{% block content %}
    ...
    <div class=\"row\">
        ...
        <div class=\"col-md-7 my-auto\"> {# my-auto centre la div sur sa voisine #}
            <h3> {{product.name }} </h3>
...
{% endblock %}
", "product/show.html.twig", "C:\\wamp64\\www\\laboutiquefrancaise\\templates\\product\\show.html.twig");
    }
}
